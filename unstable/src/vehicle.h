...
public: 
    ...
    { pos = new_pos; }
	const Pointf& get_pos()
    { return pos; }
	const Pointf& get_old_pos()
    { return old_pos; }
	const Pointf& get_vel()
    { return vel; }
...
private:
  Pointf get_vehicle_reference_velocity() const;
  Pointf translate_to_world_reference(const Pointf& vel_vr) const;
  ...
  Pointf scale;  // use this for drawing
};
